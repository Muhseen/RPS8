      <div class="c-sidebar-brand" style="background-color: green !important">
      ...
      <nav class="c-sidebar-nav" style="background-color: green !important">
        <ul class="c-nav">
      ...
      <button class="c-sidebar-minimizer c-class-toggler" style="background-color: green" type="button" data-target="_parent" data-class="c-sidebar-minimized"></button>
    </div>
